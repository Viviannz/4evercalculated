    ...
    <section id="tools" className="bg-brand-off-white px-6 py-18">
      <div className="mx-auto max-w-[1100px]">
        ...
        <div className="mt-12 grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6">
          <div className="rounded-xl border border-brand-border bg-white p-7 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-shadow hover:shadow-[0_8px_24px_rgba(0,0,0,0.12)]">
